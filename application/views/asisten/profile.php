										...
										<div class="col-xs-12 col-sm-7">
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													<div class="profile-info-name">ID Asisten</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<input type="text" name="nama_lengkap" id="nama_lengkap" class="input-medium" value="<?php echo ($this->session->userdata('nama_lengkap'));?>" readonly>
