							...
							<div class="col-xs-12">
								...
								<div class="center">
									...
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">Laporan Pendahuluan Analisa Financial Leverage</h4>
									...
									<div class="widget-body">
										<div class="widget-main" style="overflow-x:scroll;">
											<div id="fuelux-wizard-container">
												...
												<hr />
							<form action="<?php echo base_url();?>ceklp/al" method="post" >
								<div class="step-content pos-rel">
									<?php $no = 1;foreach ($soalkb->result() as $row) {?>
