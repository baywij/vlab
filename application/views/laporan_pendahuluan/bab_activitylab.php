			...
			<?php foreach ($data->result() as $key ) {
				...
				<tr>
					...
					<td class="hidden-480" style="text-align:center;">
						...
						<button <?php echo $button;?> id="" data-toggle="modal" data-target="#addDataAL<?php echo $key->minggu;?>"  <?php echo $disabled;?>> <?php echo $cek;?></button>
							<div class="modal fade" id="addDataAL<?php echo $key->minggu;?>" tabindex="-1" role="dialog" aria-labelledby="addLabel">
							    <div class="modal-dialog" role="document">
							      <div class="modal-content">
							        <div class="modal-header">
							          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
							          <h4 class="modal-title" id="addLabel"><?php echo $key->nama_bab; ?></h4>
											...
											<div class="modal-body">
												<div class="control-group">
													...
													<div class="controls">
														<center>
														<a href="<?php echo base_url()?>activity_lab/<?php echo $key->kd_bab;?>" class="btn btn-primary btn-sm" > Mulai
															</a>
															</div>
														</div>
													</div>
