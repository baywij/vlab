					...
					<form method="post" action="<?php echo base_url();?>mail/sent" id="id-message-form" class="form-horizontal message-form col-xs-12" style="">
						<div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									<span class="input-icon">
										<input type="text" name="npm_penerima" id="form-field-recipient" value="<?=$var_penerima;?>" placeholder="Masukan NPM.." readonly/>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
								<button class="btn btn-white btn-default btn-round" type="submit" name="balas">
