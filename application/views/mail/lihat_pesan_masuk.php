						...
						<div class='message-content' id='id-message-content'>
							<div class='message-header clearfix'>
								<div class='pull-left'>
									...
									<i class='ace-icon fa fa-user '></i> Dari :
									
									<span>".$Row1->namapengirim." (".$Row1->npmpengirim.")</span>
									&nbsp;
									<br>
								...
								<div class='pull-right action-buttons'>
									<a href='".base_url()."mail/reply_mail/".$Row1->id."'>
										<i class='ace-icon fa fa-reply red icon-only bigger-130'></i>
									</a>
								</div>
							</div>
