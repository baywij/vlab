<?php 
        $Id_Temp = 0;
        foreach ($data_bab->result() as $Row) 
        {
            $Id_Temp++;
...
<div class="col-xs-6 col-sm-3 pricing-box">
    <div class="widget-box widget-color-blue">
        ...
        <div class="widget-body">
            ...
            <div>
                <a href="<?php echo base_url();?>Soal/Praktikum?Kd_Matkul=<?=$Row->kd_matkul;?>&Kd_Bab=<?=$Row->kd_bab;?>&Tipe=<?=$Tipe?>" class="btn btn-block btn-primary">
