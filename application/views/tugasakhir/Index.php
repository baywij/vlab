				...
				<div class="widget-box">
					...
					<div class="widget-body">
						<div class="widget-main">
							<dl id="dt-list-1">
								<ul>
									<li>Pengerjaan Tugas akhir dilakukan pada setiap minggu </li>
...
?>				
				<tr>
					...
					<td align="center">
						<a href="<?php echo base_url();?>Tugasakhir/VeiwModvid/<?=$Row->kd_bab;?>" class="btn btn-sm btn-primary" id="id-btn-dialog2"> Mengerjakan Tugas Akhir </a>
					</td>
				</tr>
<?php
			}
		...
		else
		{
			echo " <div class='alert alert-block alert-success'	>
						</strong>Tugas Akhir tidak tersedia.
					</div>
			";
		}
?>
